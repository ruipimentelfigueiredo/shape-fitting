...
hough_orientation_results_4 = np.array(hough_orientation_results_4).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)

for line in hough_orientation_file_5:
  hough_orientation_results_5.append(180.0*float(line)/math.pi)
hough_orientation_results_5 = np.array(hough_orientation_results_5).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)


for line in hough_orientation_file_6:
  hough_orientation_results_6.append(180.0*float(line)/math.pi)
hough_orientation_results_6 = np.array(hough_orientation_results_6).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)


for line in hough_orientation_file_7:
  hough_orientation_results_7.append(180.0*float(line)/math.pi)
hough_orientation_results_7 = np.array(hough_orientation_results_7).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)
...
hough_position_results_4 = np.array(hough_position_results_4).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)

for line in hough_position_file_5:
  hough_position_results_5.append(float(line))
hough_position_results_5 = np.array(hough_position_results_5).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)

for line in hough_position_file_6:
  hough_position_results_6.append(float(line))
hough_position_results_6 = np.array(hough_position_results_6).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)

for line in hough_position_file_7:
  hough_position_results_7.append(float(line))
hough_position_results_7 = np.array(hough_position_results_7).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)
...
hough_radius_results_4 = np.array(hough_radius_results_4).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)

for line in hough_radius_file_5:
  hough_radius_results_5.append(float(line))
hough_radius_results_5 = np.array(hough_radius_results_5).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)

for line in hough_radius_file_6:
  hough_radius_results_6.append(float(line))
hough_radius_results_6 = np.array(hough_radius_results_6).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)

for line in hough_radius_file_7:
  hough_radius_results_7.append(float(line))
hough_radius_results_7 = np.array(hough_radius_results_7).reshape(iterations,ground_truth_size,outlier_levels,noise_levels_number)
...
hough_orientation_results_mean_4 = np.mean(hough_orientation_results_4, axis=(0,2))
hough_orientation_results_std_4  = np.std(hough_orientation_results_4, axis=(0,2))

hough_orientation_results_mean_5 = np.mean(hough_orientation_results_5, axis=(0,2))
hough_orientation_results_std_5  = np.std(hough_orientation_results_5, axis=(0,2))

hough_orientation_results_mean_6 = np.mean(hough_orientation_results_6, axis=(0,2))
hough_orientation_results_std_6  = np.std(hough_orientation_results_6, axis=(0,2))

hough_orientation_results_mean_7 = np.mean(hough_orientation_results_7, axis=(0,2))
hough_orientation_results_std_7  = np.std(hough_orientation_results_7, axis=(0,2))
...
hough_position_results_mean_4 = np.mean(hough_position_results_4, axis=(0,2))
hough_position_results_std_4  = np.std(hough_position_results_4, axis=(0,2))

hough_position_results_mean_5 = np.mean(hough_position_results_5, axis=(0,2))
hough_position_results_std_5  = np.std(hough_position_results_5, axis=(0,2))

hough_position_results_mean_6 = np.mean(hough_position_results_6, axis=(0,2))
hough_position_results_std_6  = np.std(hough_position_results_6, axis=(0,2))

hough_position_results_mean_7 = np.mean(hough_position_results_7, axis=(0,2))
hough_position_results_std_7  = np.std(hough_position_results_7, axis=(0,2))
...
hough_radius_results_mean_4 = np.mean(hough_radius_results_4, axis=(0,2))
hough_radius_results_std_4  = np.std(hough_radius_results_4, axis=(0,2))

hough_radius_results_mean_5 = np.mean(hough_radius_results_5, axis=(0,2))
hough_radius_results_std_5  = np.std(hough_radius_results_5, axis=(0,2))

hough_radius_results_mean_6 = np.mean(hough_radius_results_6, axis=(0,2))
hough_radius_results_std_6  = np.std(hough_radius_results_6, axis=(0,2))

hough_radius_results_mean_7 = np.mean(hough_radius_results_7, axis=(0,2))
hough_radius_results_std_7  = np.std(hough_radius_results_7, axis=(0,2))
...
print error_levels
plt.plot(error_levels,hough_orientation_results_mean_0[outlier_index,:],color=colors[0],label=labels[0],linestyle=linestyles[1])
...
plt.plot(error_levels,hough_orientation_results_mean_1[outlier_index,:],color=colors[0],label=labels[1],linestyle=linestyles[0])
...
plt.plot(error_levels,hough_orientation_results_mean_2[outlier_index,:],color=colors[1],label=labels[2],linestyle=linestyles[1])
...
plt.plot(error_levels,hough_orientation_results_mean_3[outlier_index,:],color=colors[1],label=labels[3],linestyle=linestyles[0])
error_sup=hough_orientation_results_mean_3[outlier_index,:]+hough_orientation_results_std_3[outlier_index,:];
error_inf=hough_orientation_results_mean_3[outlier_index,:]-hough_orientation_results_std_3[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[1])

plt.plot(error_levels,hough_orientation_results_mean_4[outlier_index,:],color=colors[2],label=labels[4],linestyle=linestyles[1])
error_sup=hough_orientation_results_mean_4[outlier_index,:]+hough_orientation_results_std_4[outlier_index,:];
error_inf=hough_orientation_results_mean_4[outlier_index,:]-hough_orientation_results_std_4[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(error_levels,hough_orientation_results_mean_5[outlier_index,:],color=colors[2],label=labels[5],linestyle=linestyles[0])
error_sup=hough_orientation_results_mean_5[outlier_index,:]+hough_orientation_results_std_5[outlier_index,:];
error_inf=hough_orientation_results_mean_5[outlier_index,:]-hough_orientation_results_std_5[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(error_levels,hough_orientation_results_mean_6[outlier_index,:],color=colors[3],label=labels[6],linestyle=linestyles[1])
error_sup=hough_orientation_results_mean_6[outlier_index,:]+hough_orientation_results_std_6[outlier_index,:];
error_inf=hough_orientation_results_mean_6[outlier_index,:]-hough_orientation_results_std_6[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[6])

plt.plot(error_levels,hough_orientation_results_mean_7[outlier_index,:],color=colors[3],label=labels[7],linestyle=linestyles[0])
error_sup=hough_orientation_results_mean_7[outlier_index,:]+hough_orientation_results_std_7[outlier_index,:];
error_inf=hough_orientation_results_mean_7[outlier_index,:]-hough_orientation_results_std_7[outlier_index,:];
...
### Position
plt.figure(figsize=(8, 6))
plt.plot(error_levels,hough_position_results_mean_0[outlier_index,:],color=colors[0],label=labels[0],linestyle=linestyles[1])
...
plt.plot(error_levels,hough_position_results_mean_1[outlier_index,:],color=colors[0],label=labels[1],linestyle=linestyles[0])
...
plt.plot(error_levels,hough_position_results_mean_2[outlier_index,:],color=colors[1],label=labels[2],linestyle=linestyles[1])
...
plt.plot(error_levels,hough_position_results_mean_3[outlier_index,:],color=colors[1],label=labels[3],linestyle=linestyles[0])
...
plt.plot(error_levels,hough_position_results_mean_4[outlier_index,:],color=colors[2],label=labels[4],linestyle=linestyles[1])
error_sup=hough_position_results_mean_4[outlier_index,:]+hough_position_results_std_4[outlier_index,:];
error_inf=hough_position_results_mean_4[outlier_index,:]-hough_position_results_std_4[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(error_levels,hough_position_results_mean_5[outlier_index,:],color=colors[2],label=labels[5],linestyle=linestyles[0])
error_sup=hough_position_results_mean_3[outlier_index,:]+hough_position_results_std_5[outlier_index,:];
error_inf=hough_position_results_mean_3[outlier_index,:]-hough_position_results_std_5[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(error_levels,hough_position_results_mean_6[outlier_index,:],color=colors[3],label=labels[6],linestyle=linestyles[1])
error_sup=hough_position_results_mean_6[outlier_index,:]+hough_position_results_std_6[outlier_index,:];
error_inf=hough_position_results_mean_6[outlier_index,:]-hough_position_results_std_6[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])

plt.plot(error_levels,hough_position_results_mean_7[outlier_index,:],color=colors[3],label=labels[7],linestyle=linestyles[0])
error_sup=hough_position_results_mean_7[outlier_index,:]+hough_position_results_std_7[outlier_index,:];
error_inf=hough_position_results_mean_7[outlier_index,:]-hough_position_results_std_7[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])
...
### Radius
plt.figure(figsize=(8, 6))
plt.plot(error_levels,hough_radius_results_mean_0[outlier_index,:],color=colors[0],label=labels[0],linestyle=linestyles[1])
...
plt.plot(error_levels,hough_radius_results_mean_1[outlier_index,:],color=colors[0],label=labels[1],linestyle=linestyles[0])
...
plt.plot(error_levels,hough_radius_results_mean_2[outlier_index,:],color=colors[1],label=labels[2],linestyle=linestyles[1])
...
plt.plot(error_levels,hough_radius_results_mean_3[outlier_index,:],color=colors[1],label=labels[3],linestyle=linestyles[0])
...
plt.plot(error_levels,hough_radius_results_mean_4[outlier_index,:],color=colors[2],label=labels[4],linestyle=linestyles[1])
error_sup=hough_radius_results_mean_4[outlier_index,:]+hough_radius_results_std_4[outlier_index,:];
error_inf=hough_radius_results_mean_4[outlier_index,:]-hough_radius_results_std_4[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(error_levels,hough_radius_results_mean_5[outlier_index,:],color=colors[2],label=labels[5],linestyle=linestyles[0])
error_sup=hough_radius_results_mean_5[outlier_index,:]+hough_radius_results_std_5[outlier_index,:];
error_inf=hough_radius_results_mean_5[outlier_index,:]-hough_radius_results_std_5[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(error_levels,hough_radius_results_mean_6[outlier_index,:],color=colors[3],label=labels[6],linestyle=linestyles[1])
error_sup=hough_radius_results_mean_6[outlier_index,:]+hough_radius_results_std_6[outlier_index,:];
error_inf=hough_radius_results_mean_6[outlier_index,:]-hough_radius_results_std_6[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])

plt.plot(error_levels,hough_radius_results_mean_7[outlier_index,:],color=colors[3],label=labels[7],linestyle=linestyles[0])
error_sup=hough_radius_results_mean_7[outlier_index,:]+hough_radius_results_std_7[outlier_index,:];
error_inf=hough_radius_results_mean_7[outlier_index,:]-hough_radius_results_std_7[outlier_index,:];
plt.fill_between(error_levels,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])
...
### Orientation
plt.figure(figsize=(8, 6))
plt.plot(outlier_levels_,hough_orientation_results_mean_0[:,noise_index],color=colors[0],label=labels[0],linestyle=linestyles[1])
...
plt.plot(outlier_levels_,hough_orientation_results_mean_1[:,noise_index],color=colors[0],label=labels[1],linestyle=linestyles[0])
...
plt.plot(outlier_levels_,hough_orientation_results_mean_2[:,noise_index],color=colors[1],label=labels[2],linestyle=linestyles[1])
...
plt.plot(outlier_levels_,hough_orientation_results_mean_3[:,noise_index],color=colors[1],label=labels[3],linestyle=linestyles[0])
...
plt.plot(outlier_levels_,hough_orientation_results_mean_4[:,noise_index],color=colors[2],label=labels[5],linestyle=linestyles[1])
error_sup=hough_orientation_results_mean_4[:,noise_index]+hough_orientation_results_std_4[:,noise_index];
error_inf=hough_orientation_results_mean_4[:,noise_index]-hough_orientation_results_std_4[:,noise_index];
...
plt.plot(outlier_levels_,hough_orientation_results_mean_5[:,noise_index],color=colors[2],label=labels[5],linestyle=linestyles[0])
error_sup=hough_orientation_results_mean_5[:,noise_index]+hough_orientation_results_std_5[:,noise_index];
error_inf=hough_orientation_results_mean_5[:,noise_index]-hough_orientation_results_std_5[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(outlier_levels_,hough_orientation_results_mean_6[:,noise_index],color=colors[3],label=labels[6],linestyle=linestyles[1])
error_sup=hough_orientation_results_mean_6[:,noise_index]+hough_orientation_results_std_6[:,noise_index];
error_inf=hough_orientation_results_mean_6[:,noise_index]-hough_orientation_results_std_6[:,noise_index];
...
plt.plot(outlier_levels_,hough_orientation_results_mean_7[:,noise_index],color=colors[3],label=labels[7],linestyle=linestyles[0])
error_sup=hough_orientation_results_mean_7[:,noise_index]+hough_orientation_results_std_7[:,noise_index];
error_inf=hough_orientation_results_mean_7[:,noise_index]-hough_orientation_results_std_7[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])
...
### Position
plt.figure(figsize=(8, 6))
plt.plot(outlier_levels_,hough_position_results_mean_0[:,noise_index],color=colors[0],label=labels[0],linestyle=linestyles[1])
...
plt.plot(outlier_levels_,hough_position_results_mean_1[:,noise_index],color=colors[0],label=labels[1],linestyle=linestyles[0])
...
plt.plot(outlier_levels_,hough_position_results_mean_2[:,noise_index],color=colors[1],label=labels[2],linestyle=linestyles[1])
...
plt.plot(outlier_levels_,hough_position_results_mean_3[:,noise_index],color=colors[1],label=labels[3],linestyle=linestyles[0])
...
plt.plot(outlier_levels_,hough_position_results_mean_4[:,noise_index],color=colors[2],label=labels[4],linestyle=linestyles[1])
error_sup=hough_position_results_mean_4[:,noise_index]+hough_position_results_std_4[:,noise_index];
error_inf=hough_position_results_mean_4[:,noise_index]-hough_position_results_std_4[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(outlier_levels_,hough_position_results_mean_5[:,noise_index],color=colors[2],label=labels[5],linestyle=linestyles[0])
error_sup=hough_position_results_mean_5[:,noise_index]+hough_position_results_std_5[:,noise_index];
error_inf=hough_position_results_mean_5[:,noise_index]-hough_position_results_std_5[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(outlier_levels_,hough_position_results_mean_6[:,noise_index],color=colors[3],label=labels[6],linestyle=linestyles[1])
error_sup=hough_position_results_mean_6[:,noise_index]+hough_position_results_std_6[:,noise_index];
error_inf=hough_position_results_mean_6[:,noise_index]-hough_position_results_std_6[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])

plt.plot(outlier_levels_,hough_position_results_mean_7[:,noise_index],color=colors[3],label=labels[7],linestyle=linestyles[0])
error_sup=hough_position_results_mean_7[:,noise_index]+hough_position_results_std_7[:,noise_index];
error_inf=hough_position_results_mean_7[:,noise_index]-hough_position_results_std_7[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])
...
### Radius
plt.figure(figsize=(8, 6))
plt.plot(outlier_levels_,hough_radius_results_mean_0[:,noise_index],color=colors[0],label=labels[0],linestyle=linestyles[1])
...
plt.plot(outlier_levels_,hough_radius_results_mean_1[:,noise_index],color=colors[0],label=labels[1],linestyle=linestyles[0])
...
plt.plot(outlier_levels_,hough_radius_results_mean_2[:,noise_index],color=colors[1],label=labels[2],linestyle=linestyles[1])
...
plt.plot(outlier_levels_,hough_radius_results_mean_3[:,noise_index],color=colors[1],label=labels[3],linestyle=linestyles[0])
...
plt.plot(outlier_levels_,hough_radius_results_mean_4[:,noise_index],color=colors[2],label=labels[4],linestyle=linestyles[1])
error_sup=hough_radius_results_mean_4[:,noise_index]+hough_radius_results_std_4[:,noise_index];
error_inf=hough_radius_results_mean_4[:,noise_index]-hough_radius_results_std_4[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(outlier_levels_,hough_radius_results_mean_5[:,noise_index],color=colors[2],label=labels[5],linestyle=linestyles[0])
error_sup=hough_radius_results_mean_5[:,noise_index]+hough_radius_results_std_5[:,noise_index];
error_inf=hough_radius_results_mean_5[:,noise_index]-hough_radius_results_std_5[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(outlier_levels_,hough_radius_results_mean_6[:,noise_index],color=colors[3],label=labels[6],linestyle=linestyles[1])
error_sup=hough_radius_results_mean_6[:,noise_index]+hough_radius_results_std_6[:,noise_index];
error_inf=hough_radius_results_mean_6[:,noise_index]-hough_radius_results_std_6[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])

plt.plot(outlier_levels_,hough_radius_results_mean_7[:,noise_index],color=colors[3],label=labels[7],linestyle=linestyles[0])
error_sup=hough_radius_results_mean_7[:,noise_index]+hough_radius_results_std_7[:,noise_index];
error_inf=hough_radius_results_mean_7[:,noise_index]-hough_radius_results_std_7[:,noise_index];
plt.fill_between(outlier_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])
...
plt.plot(occlusion_levels_,hough_orientation_results_mean_1[:,noise_index],color=colors[0],label=labels[1])
error_sup=hough_orientation_results_mean_1[:,noise_index]+hough_orientation_results_std_1[:,noise_index];
error_inf=hough_orientation_results_mean_1[:,noise_index]-hough_orientation_results_std_1[:,noise_index];
plt.fill_between(occlusion_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[0])

plt.plot(occlusion_levels_,hough_orientation_results_mean_2[:,noise_index],color=colors[1],label=labels[2])
error_sup=hough_orientation_results_mean_2[:,noise_index]+hough_orientation_results_std_2[:,noise_index];
error_inf=hough_orientation_results_mean_2[:,noise_index]-hough_orientation_results_std_2[:,noise_index];
...
plt.plot(occlusion_levels_,hough_orientation_results_mean_3[:,noise_index],color=colors[1],label=labels[3])
error_sup=hough_orientation_results_mean_3[:,noise_index]+hough_orientation_results_std_3[:,noise_index];
error_inf=hough_orientation_results_mean_3[:,noise_index]-hough_orientation_results_std_3[:,noise_index];
plt.fill_between(occlusion_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[1])

plt.plot(occlusion_levels_,hough_orientation_results_mean_4[:,noise_index],color=colors[2],label=labels[4])
error_sup=hough_orientation_results_mean_4[:,noise_index]+hough_orientation_results_std_4[:,noise_index];
error_inf=hough_orientation_results_mean_4[:,noise_index]-hough_orientation_results_std_4[:,noise_index];
...
plt.plot(occlusion_levels_,hough_orientation_results_mean_5[:,noise_index],color=colors[2],label=labels[5])
error_sup=hough_orientation_results_mean_5[:,noise_index]+hough_orientation_results_std_5[:,noise_index];
error_inf=hough_orientation_results_mean_5[:,noise_index]-hough_orientation_results_std_5[:,noise_index];
plt.fill_between(occlusion_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[2])

plt.plot(occlusion_levels_,hough_orientation_results_mean_6[:,noise_index],color=colors[3],label=labels[6])
error_sup=hough_orientation_results_mean_6[:,noise_index]+hough_orientation_results_std_6[:,noise_index];
error_inf=hough_orientation_results_mean_6[:,noise_index]-hough_orientation_results_std_6[:,noise_index];
...
plt.plot(occlusion_levels_,hough_orientation_results_mean_7[:,noise_index],color=colors[3],label=labels[7])
error_sup=hough_orientation_results_mean_7[:,noise_index]+hough_orientation_results_std_7[:,noise_index];
error_inf=hough_orientation_results_mean_7[:,noise_index]-hough_orientation_results_std_7[:,noise_index];
plt.fill_between(occlusion_levels_,error_sup,error_inf,where=error_inf<=error_sup,interpolate=True,alpha=alpha_,color=colors[3])
